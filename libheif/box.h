...
#define fourcc(id) (((uint32_t)(id[0])<<24) | (id[1]<<16) | (id[2]<<8) | (id[3]))
  ...
  */
  ...
  public:
    ...
    Box_moov(const BoxHeader& hdr) : Box(hdr)
    {}
    std::string dump(Indent&) const override;
  ...
  public:
    ...
    Box_mvhd(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_trak(const BoxHeader& hdr) : Box(hdr)
    {}
    std::string dump(Indent&) const override;
  ...
  public:
    ...
    Box_tkhd(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_mdia(const BoxHeader& hdr) : Box(hdr)
    {}
    std::string dump(Indent&) const override;
  ...
  public:
    ...
    Box_mdhd(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_minf(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_vmhd(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_stbl(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_stsd(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_hvc1(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_ccst(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_stsz(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_stts(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_stsc(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_stco(const BoxHeader& hdr) : Box(hdr)
    {}
  ...
  public:
    ...
    Box_stss(const BoxHeader& hdr) : Box(hdr)
    {}
