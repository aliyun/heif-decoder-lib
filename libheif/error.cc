...
const char* Error::get_error_string(heif_suberror_code err)
{
  switch (err) {
    ...
    case heif_suberror_No_mvhd_box:
      return "No 'mvhd' box";
    case heif_suberror_No_trak_box:
      return "No 'trak' box";
    case heif_suberror_No_tkhd_box:
      return "No 'tkhd' box";
    case heif_suberror_No_mdia_box:
      return "No 'mdia' box";
    case heif_suberror_No_mdhd_box:
      return "No 'mdhd' box";
    case heif_suberror_No_minf_box:
      return "No 'minf' box";
    case heif_suberror_No_vmhd_box:
      return "No 'vmhd' box";
    case heif_suberror_No_stbl_box:
      return "No 'stbl' box";
    case heif_suberror_No_stsd_box:
      return "No 'stsd' box";
    case heif_suberror_No_hvc1_box:
      return "No 'hvc1' box";
    case heif_suberror_No_hvcC_moov_box:
      return "No 'hvcC moov' box";
    case heif_suberror_No_ccst_box:
      return "No 'hvcC ccst' box";
    case heif_suberror_No_stsz_box:
      return "No 'hvcC stsz' box";
    case heif_suberror_No_stts_box:
      return "No 'hvcC stts' box";
    case heif_suberror_No_stsc_box:
      return "No 'hvcC stsc' box";
    case heif_suberror_No_stco_box:
      return "No 'hvcC stco' box";
    case heif_suberror_No_stss_box:
      return "No 'hvcC stss' box";
