...
//void intra_prediction_planar_neon(pixel_t* dst, int dstStride,
//                                  int nT,int cIdx,
//                                  pixel_t* border)
//{
//  int Log2_nT = Log2(nT);
...
//      uint8x8_t val = WeightedBlend(vref_l,vref_r,(uint8_t)iFact);
...
//      uint8x8_t val = WeightedBlend(vref_l,vref_r,vsFact, vreinterpret_u8_s8(viFact));
...
//      uint8x8_t val = WeightedBlend(vref_l,vref_r,vsFact, viFact);
      uint16x8_t weight_a = vmull_u8(vref_l,vsFact);
