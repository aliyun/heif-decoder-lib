...
void transform_idct_add(pixel_t *dst, ptrdiff_t stride,
                        int nT, const int16_t *coeffs, int bit_depth, int16_t col_limit)
{
  /*
...
{
  transform_idct_add<uint8_t>(dst,stride,  4, coeffs, 8, col_limit);
}

void transform_8x8_add_8_fallback(uint8_t *dst, /*const*/ int16_t *coeffs, ptrdiff_t stride, int16_t col_limit)
{
  transform_idct_add<uint8_t>(dst,stride,  8, coeffs, 8, col_limit);
}

void transform_16x16_add_8_fallback(uint8_t *dst, /*const*/ int16_t *coeffs, ptrdiff_t stride, int16_t col_limit)
{
  transform_idct_add<uint8_t>(dst,stride,  16, coeffs, 8, col_limit);
}

void transform_32x32_add_8_fallback(uint8_t *dst, /*const*/ int16_t *coeffs, ptrdiff_t stride, int16_t col_limit)
{
  transform_idct_add<uint8_t>(dst,stride,  32, coeffs, 8, col_limit);
}


void transform_4x4_add_16_fallback(uint16_t *dst, /*const*/ int16_t *coeffs, ptrdiff_t stride, int bit_depth, int16_t col_limit)
{
  transform_idct_add<uint16_t>(dst,stride,  4, coeffs, bit_depth, col_limit);
}

void transform_8x8_add_16_fallback(uint16_t *dst, /*const*/ int16_t *coeffs, ptrdiff_t stride, int bit_depth, int16_t col_limit)
{
  transform_idct_add<uint16_t>(dst,stride,  8, coeffs, bit_depth, col_limit);
}

void transform_16x16_add_16_fallback(uint16_t *dst, /*const*/ int16_t *coeffs, ptrdiff_t stride, int bit_depth, int16_t col_limit)
{
  transform_idct_add<uint16_t>(dst,stride,  16, coeffs, bit_depth, col_limit);
}

void transform_32x32_add_16_fallback(uint16_t *dst, /*const*/ int16_t *coeffs, ptrdiff_t stride, int bit_depth, int16_t col_limit)
{
  transform_idct_add<uint16_t>(dst,stride,  32, coeffs, bit_depth, col_limit);
}
